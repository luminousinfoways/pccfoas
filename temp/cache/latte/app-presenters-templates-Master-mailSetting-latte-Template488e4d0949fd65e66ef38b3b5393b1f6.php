<?php
// source: /var/www/html/pccf/app/presenters/templates/Master/mailSetting.latte

class Template488e4d0949fd65e66ef38b3b5393b1f6 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('f8a94b99c9', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb8a98f617ba_content')) { function _lb8a98f617ba_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div id="content">
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lbdd19375513_scripts')) { function _lbdd19375513_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb6b23bbc5af_head')) { function _lb6b23bbc5af_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
