<?php
// source: /var/www/html/pccf/app/presenters/templates/Master/dateTimeEdit.latte

class Template017108cb83a606b07432bbfe163f18bc extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('a3f43bbffe', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lbe0fdcb2a80_content')) { function _lbe0fdcb2a80_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div id="banner">
<?php call_user_func(reset($_b->blocks['title']), $_b, get_defined_vars())  ?>
</div>
<div id="content">
	<h2>Edit Date Time Setting</h2>
	<div class="boxes">		
...
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lbd7719689db_title')) { function _lbd7719689db_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lbd4121fe4d3_scripts')) { function _lbd4121fe4d3_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lbc056219b05_head')) { function _lbc056219b05_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><style>
