<?php
// source: /var/www/html/pccfoas/app/presenters/templates/Homepage/default.latte

class Template6d55fb952d594215529bf18ff81fccbb extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('139f5f3016', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lba7a45c248d_content')) { function _lba7a45c248d_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div id="banner">
...
<?php $iterations = 0; foreach ($posts as $post) { ?>	<div class="data">
 ...
 <a href="<?php echo Latte\Runtime\Filters::escapeHtml($_control->link("edit", array($post->post_id)), ENT_COMPAT) ?>
">(Edit)</a></h2>
...
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lbf0307a11c7_title')) { function _lbf0307a11c7_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb944dd601e5_scripts')) { function _lb944dd601e5_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb1848a74502_head')) { function _lb1848a74502_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><style>
