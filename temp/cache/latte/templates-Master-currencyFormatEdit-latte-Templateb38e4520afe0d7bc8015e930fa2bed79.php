<?php
// source: /var/www/html/pccf/app/presenters/templates/Master/currencyFormatEdit.latte

class Templateb38e4520afe0d7bc8015e930fa2bed79 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('291370d5df', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lbec83fc84fe_content')) { function _lbec83fc84fe_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div id="banner">
...
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lb5234510cb2_title')) { function _lb5234510cb2_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb169b4bdd2d_scripts')) { function _lb169b4bdd2d_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb977be18f57_head')) { function _lb977be18f57_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><style>
