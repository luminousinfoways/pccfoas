<?php
// source: /var/www/html/pccf/app/presenters/templates/Homepage/default.latte

class Template4150f1835e0caae3059a5a61f670c084 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('ce95a6df05', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb2bd0cab6dd_content')) { function _lb2bd0cab6dd_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div id="banner">
...
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lbfccd63d41e_title')) { function _lbfccd63d41e_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb59a7e2ecf0_scripts')) { function _lb59a7e2ecf0_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb2c01fa7192_head')) { function _lb2c01fa7192_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><style>
