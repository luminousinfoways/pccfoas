<?php
// source: /var/www/html/pccfoas/app/presenters/templates/Master/dateTimeSetting.latte

class Template7a6ef8dffb1b457b24ad3a48df8e7a40 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('e4fea34573', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb807083ac08_content')) { function _lb807083ac08_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div id="content">
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lbb3c4a314ef_scripts')) { function _lbb3c4a314ef_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lbccb395e0be_head')) { function _lbccb395e0be_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><style>
