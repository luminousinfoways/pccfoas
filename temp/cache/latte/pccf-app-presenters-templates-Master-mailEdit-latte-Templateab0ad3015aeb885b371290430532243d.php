<?php
// source: /var/www/html/pccf/app/presenters/templates/Master/mailEdit.latte

class Templateab0ad3015aeb885b371290430532243d extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('1699d00793', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb8c966989c1_content')) { function _lb8c966989c1_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div id="banner">
<?php call_user_func(reset($_b->blocks['title']), $_b, get_defined_vars())  ?>
</div>
<div id="content">
	<h2>Edit Mail Setting</h2>
	<div class="boxes">		
...
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lb96a596b789_title')) { function _lb96a596b789_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb838e5eee78_scripts')) { function _lb838e5eee78_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lbfdc929491c_head')) { function _lbfdc929491c_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><style>
