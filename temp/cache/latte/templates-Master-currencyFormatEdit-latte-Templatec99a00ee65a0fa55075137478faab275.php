<?php
// source: /var/www/html/pccfoas/app/presenters/templates/Master/currencyFormatEdit.latte

class Templatec99a00ee65a0fa55075137478faab275 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('f62fe87c65', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lbe648977514_content')) { function _lbe648977514_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div id="banner">
<?php call_user_func(reset($_b->blocks['title']), $_b, get_defined_vars())  ?>
</div>
<div id="content">
	<h2>Edit Currency Format</h2>
	<div class="boxes">		
...
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lb9989013385_title')) { function _lb9989013385_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb1112596591_scripts')) { function _lb1112596591_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb2335c8c0e0_head')) { function _lb2335c8c0e0_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><style>
