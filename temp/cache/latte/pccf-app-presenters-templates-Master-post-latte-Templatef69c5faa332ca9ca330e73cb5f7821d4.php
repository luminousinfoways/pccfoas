<?php
// source: /var/www/html/pccf/app/presenters/templates/Master/post.latte

class Templatef69c5faa332ca9ca330e73cb5f7821d4 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('b29fea5f8d', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lbea1c0d1ade_content')) { function _lbea1c0d1ade_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div id="banner">
...
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lb2d51451ca3_title')) { function _lb2d51451ca3_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lbaf5856d5c0_scripts')) { function _lbaf5856d5c0_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb56ab1238d8_head')) { function _lb56ab1238d8_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><style>
