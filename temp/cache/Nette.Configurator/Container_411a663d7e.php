<?php
// source: /var/www/html/pccfoas/app/config/config.neon 
// source: /var/www/html/pccfoas/app/config/config.local.neon 

class Container_411a663d7e extends Nette\DI\Container
{
	protected $meta = array(
		'types' => array(
			...
			'App\Presenters\BasePresenter' => array(array('application.1', 'application.4')),
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => '/var/www/html/pccfoas/app',
			'wwwDir' => '/var/www/html/pccfoas/www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'environment' => 'development',
			'consoleMode' => FALSE,
			'container' => array('class' => NULL, 'parent' => NULL),
			'tempDir' => '/var/www/html/pccfoas/app/../temp',
		));
	}
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, '/var/www/html/pccfoas/app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('/var/www/html/pccfoas/app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/var/www/html/pccfoas/app/../temp/cache', $this->getService('cache.journal'));
		return $service;
	}
	...
	{
		return new Container_411a663d7e_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	public function createServiceNette__latte()
	{
		...
		trigger_error('Service nette.latte is deprecated, implement Nette\Bridges\ApplicationLatte\ILatteFactory.',
			16384);
		$service->setTempDirectory('/var/www/html/pccfoas/app/../temp/cache/latte');
...
final class Container_411a663d7e_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_411a663d7e $container)
	{
