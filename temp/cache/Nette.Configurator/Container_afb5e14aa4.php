<?php
// source: /var/www/html/pccf/app/config/config.neon 
// source: /var/www/html/pccf/app/config/config.local.neon 

class Container_afb5e14aa4 extends Nette\DI\Container
{
	protected $meta = array(
		'types' => array(
			...
			'App\Presenters\MasterPresenter' => array(array('application.2')),
			'App\Presenters\ErrorPresenter' => array(array('application.3')),
			'App\Presenters\BasePresenter' => array(array('application.4', 'application.5')),
			'App\Presenters\SignPresenter' => array(array('application.4')),
			'App\Presenters\Error4xxPresenter' => array(array('application.5')),
		...
		'services' => array(
			...
			'application.2' => 'App\Presenters\MasterPresenter',
			'application.3' => 'App\Presenters\ErrorPresenter',
			'application.4' => 'App\Presenters\SignPresenter',
			'application.5' => 'App\Presenters\Error4xxPresenter',
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => '/var/www/html/pccf/app',
			'wwwDir' => '/var/www/html/pccf/www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'environment' => 'development',
			'consoleMode' => FALSE,
			'container' => array('class' => NULL, 'parent' => NULL),
			'tempDir' => '/var/www/html/pccf/app/../temp',
		));
	}
	...
	/**
	 * @return App\Presenters\MasterPresenter
	 */
	public function createServiceApplication__2()
	{
		$service = new App\Presenters\MasterPresenter($this->getService('database.default.context'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'), $this->getService('routing.router'),
			$this->getService('http.request'), $this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
		$service->invalidLinkMode = 5;
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, '/var/www/html/pccf/app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('/var/www/html/pccf/app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/var/www/html/pccf/app/../temp/cache', $this->getService('cache.journal'));
		return $service;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=45.114.50.54;dbname=pccfoas', 'pccf', '1234!', array('lazy' => TRUE));
	...
	{
		return new Container_afb5e14aa4_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	public function createServiceNette__latte()
	{
		...
		trigger_error('Service nette.latte is deprecated, implement Nette\Bridges\ApplicationLatte\ILatteFactory.',
			16384);
		$service->setTempDirectory('/var/www/html/pccf/app/../temp/cache/latte');
...
final class Container_afb5e14aa4_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_afb5e14aa4 $container)
	{
